...
namespace App.PET
{
    ...
    public class MainActivity : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        public bool OnNavigationItemSelected(IMenuItem item)
        {
            ...
            {
                Intent intent = new Intent(this, typeof(SearchPetActivity));
                StartActivity(intent);
            }
            else if (id == Resource.Id.nav_appointment)
            {
                Intent intent = new Intent(this, typeof(AppointmentActivity));
                StartActivity(intent);
            }
            ...
            else if (id == Resource.Id.nav_configuration)
            {
